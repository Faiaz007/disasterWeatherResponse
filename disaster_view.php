            ...
            <tbody> 
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-info" href="disaster_update.php?id=<?php echo $row['event_id']; ?>">Edit</a>&nbsp;
                                <a class="btn btn-danger" href="disaster_delete.php?id=<?php echo $row['event_id']; ?>">Delete</a>
                            </td>
                        </tr>                       
                <?php   }
                } else {
